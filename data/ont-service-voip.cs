...
namespace Ia.Ngn.Cl.Model.Data
{
    ...
    /// ONT-SERVICEVOIP support class for Next Generation Network (NGN) data model.
    /// </summary>
    /// 
    /// <remarks> 
    ...
    public partial class OntServiceVoip
    {
        ...
        ///
        /// </summary>
        public static List<Ia.Ngn.Cl.Model.OntServiceVoip> ReadListBySerial(string serial)
        {
